...
Event.create(img_url: 'https://thenypost.files.wordpress.com/2018/11/181129-soccer-ball-feature-image.jpg?quality=90&strip=all&w=915', city: 'Houston', state: 'TX', date: dateFuture, description: 'game1 description',name: 'space city', founder_id: 1, type_id: 1, location: '3223 old chapel dr', lat: 30, lng: -95)
Event.create(img_url: 'https://thenypost.files.wordpress.com/2018/11/181129-soccer-ball-feature-image.jpg?quality=90&strip=all&w=915', city: 'Houston', state: 'TX', date: dateFuture, description: 'game2 description',name: 'basketball', founder_id: 3, type_id: 2, location: '3223 old chapel dr', lat: 29.8, lng: -95.3)
Event.create(img_url: 'https://thenypost.files.wordpress.com/2018/11/181129-soccer-ball-feature-image.jpg?quality=90&strip=all&w=915', city: 'Houston', state: 'TX', date: dateFuture, description: 'game3 description',name: '10th floor pingpong', founder_id: 2, type_id: 3, location: '3223 old chapel dr', lat: 29.8, lng: -95.1)
Event.create(img_url: 'https://thenypost.files.wordpress.com/2018/11/181129-soccer-ball-feature-image.jpg?quality=90&strip=all&w=915', city: 'Houston', state: 'TX', date: dateBefore, description: 'game4 description',name: 'sy', founder_id: 1, type_id: 1, location: 'facebook', lat: 30.1, lng: -95.2)
Event.create(img_url: 'https://thenypost.files.wordpress.com/2018/11/181129-soccer-ball-feature-image.jpg?quality=90&strip=all&w=915', city: 'Houston', state: 'TX', date: dateBefore, description: 'game5 description',name: 'btball', founder_id: 3, type_id: 2, location: 'google', lat: 29.8, lng: -95.09)
